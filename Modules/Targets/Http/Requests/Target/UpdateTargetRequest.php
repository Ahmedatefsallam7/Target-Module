...
class UpdateTargetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $endDate = Carbon::parse(request()->input('end_date')  ?? $this->end_date);

        return [
            "id" => "required|exists:targets,id",
            "user_id" => "nullable|exists:users,id",
            'title' => "nullable|string|min:3|unique:targets,title,$this->id",
            ...
            'start_date' => "nullable|date|after:$now|before_or_equal:$endDate",
